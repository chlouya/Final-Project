...
const happyCatBtn = document.getElementById('happyCatBtn');
const madCatBtn = document.getElementById('madCatBtn');
const surprisedCatBtn = document.getElementById('surprisedCatBtn');
const sadCatBtn = document.getElementById('sadCatBtn');
